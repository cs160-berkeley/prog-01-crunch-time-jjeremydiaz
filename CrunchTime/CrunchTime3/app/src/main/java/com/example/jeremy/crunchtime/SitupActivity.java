...
public class SitupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mButton = (Button) findViewById(R.id.calculate_button2);
        final EditText mEdit = (EditText) findViewById(R.id.situp_results);
    ...
    public double calculate_calories(double reps){
        return reps * calories_per_situp;
    }
    public String getConversions(double calories){
        return "You have burned " + calories + " calories. To burn the same calories you will need to do "
                ...
                + " pushups, " + String.valueOf(calories/calories_per_jumpingjacks) + " minutes of jumping jacks and "
